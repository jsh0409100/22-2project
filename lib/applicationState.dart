...
class ApplicationState extends ChangeNotifier {
    ...
    FirebaseAuth.instance
      ...
      if (user != null) {
        ...
        _productSubscription = FirebaseFirestore.instance
            .collection('products')
            .orderBy('productCreated', descending: false)
            .snapshots()
            .listen((snapshot){
          _products = [];
  ...
  Future<DocumentReference> addProductToMarket(String name, String price, String desc){
    if (_loginState != ApplicationLoginState.loggedIn) {
      throw Exception('Must be logged in');
    }
  ...
  Future<void> updateProduct(String docId, String name, String price, String desc){
    if (_loginState != ApplicationLoginState.loggedIn) {
      throw Exception('Must be logged in');
    }
